...
Example Python (3.14) code for accessing the API of (password-protected) Shelly devices.
...
* rename [credentials.EXAMPLE.py](credentials.EXAMPLE.py) and set Shelly IP and login credentials
* [read_api_v1.py](read_api_v1.py) example code for Shelly Plug S using API gen1
* [read_api_v2.py](read_api_v2.py) example code for Shelly Plus Plug S using API gen2
